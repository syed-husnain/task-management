<li class="nav-item dropdown" id="notification">
    ...
    <div class="dropdown-menu dropdown-menu-right" style="min-width: 400px;"
        ...
        <div class="text-center">
            ...
            <a href="{{ route('notification.index') }}" class="dropdown-item append-url pull-right">
                See All
            </a>
        </div>
    </div>
...
<script>
    ...
    const recentNotificationURL = '{{ route('notification.recent-ajax') }}';
    const markAllNotificationURL = '{{ route('notification.mark-all-ajax') }}';
    const readNotificationURL = '{{ route('notification.read-ajax', ':id') }}';
